...
namespace TheLastWord
{
    class Program
    {
        ...
        {
            StreamReader input = new StreamReader(@"D:\codejam\TheLastWord\A-small-attempt0.in");
            StreamWriter output = new StreamWriter(@"D:\codejam\TheLastWord\A-small-attempt0.out");
