...
/*
//for (int i=1;i<=3000;++i) cout << i << ": " << int(happy(i,10)) << endl;
    cout << f((1<<10)+(1<<2)+(1<<3)+(1<<5)+(1<<7)+(1<<4)) << endl;
    cout << f((1<<6)+(1<<8)) << endl;
    for (int i=2;i<=10;++i) for (int j=i+1;j<=10;++j) for (int k=j+1;k<=10;++k) {
        cout << i << ", "  << j << ", " << k << " = " << f((1<<i)+(1<<j)+(1<<k)) << endl;
    }*/
    int t; cin >> t;
    string s;
    getline(cin,s);
