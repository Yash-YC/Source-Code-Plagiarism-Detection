...
public class Main {
	...
	public static void main(String[] args) throws Exception{
		new Main("C:\\Documents and Settings\\TEMP.TD-CSF.000\\workspace\\CodeJam Round 1A\\src\\input\\pedestrian2.txt",
				"C:\\Documents and Settings\\TEMP.TD-CSF.000\\workspace\\CodeJam Round 1A\\src\\output\\pedestrian2.txt").run();
	}
	...
	public void run() throws Exception{
		...
		for(int i=1;i<=cases;i++){
			...
			Solver model = new PedestrianSolver(input);
			String $ = model.solve();
			output("Case #"+i+": ");
			outputln($);
